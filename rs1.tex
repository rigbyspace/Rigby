...
The \textbf{Structural Entropy} of a state $s=(n,d)$ is defined by the discrete rank of its geometric capacity:
\[ H(s) := \rho(d) \]
This quantifies the structural depth of the state's metric basis.
\end{definition}
